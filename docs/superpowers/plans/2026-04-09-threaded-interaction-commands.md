...
- [x] **Step 1: Add failing tests for thread metadata round-trip and command audit append**
...
- [x] **Step 4: Implement store helpers**
...
- [x] **Step 3: Implement parser + command enum**
...
- [x] **Step 1: Add trait methods and failing adapter tests**
...
- [x] **Step 2: Run tracker tests and verify failures**
...
- [x] **Step 3: Implement GitHub adapter behavior**
...
- [x] **Step 2: Run targeted orchestrator tests and verify failures**
...
- [x] **Step 3: Implement thread creation on block**
...
- [x] **Step 4: Implement periodic command ingestion during ticks**
...
- [x] **Step 5: Implement first-valid-command lock semantics**
...
- [x] **Step 1: Add failing config + prompt assembly tests**
...
- [x] **Step 3: Implement config + injection logic**
...
- [x] **Step 1: Add failing API tests for thread + command audit fields**
...
- [x] **Step 3: Update response schema + handlers**

Expose additive fields without breaking existing clients.

- [x] **Step 4: Re-run API/OpenAPI tests**
...
- [x] **Step 1: Update SPEC with v1 command semantics**
...
- [x] **Step 2: Update configuration docs**
...
- [x] **Step 3: Update pipeline guidance**
...
- [x] **Step 5: Run docs consistency checks**
